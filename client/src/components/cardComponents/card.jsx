...
export default function CardComp({removeGetRes,hideFav,hideRes,compDidmountF,compDidmount,reserveShow,favoriteNotEmp,adults,dateDifferenceNumber, reservationArray,favoritesArray,data,currentUser, checkIn, checkOut, searchValue, cityAndCountry, handleSeachButtonClick }) {
    return (<div>
