...
//                     </h2>
//                     <label className="label1" htmlFor="username">Email : ameed asmah</label>

//                     <label className="label1" htmlFor="email">Email : ameed.asmah1@gmail.com</label>

//                     <label className="label1" htmlFor="creditcard">cardnumber : "1234-1234-1234-1234"</label>

//                     <label className="label1" htmlFor="favourit number">favorite number : "4" </label>

//                     <label className="label1" htmlFor="res number">res number : 2</label>
